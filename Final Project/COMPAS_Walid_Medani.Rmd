---
title: <br><center>A Diary Study on Algorithmic Literacy, Analyzing Racial Bias in the Algorithm of COMPAS</center>
author: "<center> Walid Medani </center>"
date: "<center> 05/04/20 </center>"
output:
...
compasnon <- compas_raw %>%
        ...
        mutate(is_med_or_high_risk = as.integer(decile_score>=5)) %>% 
...
summary(logistic)
```
Black defendants were 45% more likely than white defendants to receive a higher score correcting for the seriousness of their crime, previous arrests, and future criminal behavior.
```{r}
